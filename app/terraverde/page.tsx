...
export default function aerthys() {
    ...
    const planetDesribe = "Terraverde is a temperate terrestrial planet with near-Earth characteristics (0.95 Earth masses, 0.98 g surface gravity) supporting extensive biodiversity across multiple biome types. Dense deciduous and evergreen forest ecosystems cover approximately 35% of the planetary landmass, with canopy heights exceeding 60 meters in mature growth regions. The hydrological cycle includes 60% oceanic coverage and a 10% freshwater network of rivers, lakes, and wetland systems that support high biological productivity. Atmospheric composition closely mirrors Earth parameters (78.9% N₂, 20.7% O₂) with methane concentrations of 1.8 ppm indicating active wetland biogenic processes. The planet's 24° axial tilt produces moderate seasonal variations that drive ecosystem dynamics, while the 350.3-day orbital period aligns with natural biological growth cycles."
    const orbitalData = 
        {
